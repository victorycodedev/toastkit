...
namespace Victorycodedev\Toastkit\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for Toastkit plugin.
 *
...
{
    protected $signature = 'nativephp:toastkit:copy-assets';

    protected $description = 'Copy assets for Toastkit plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for Toastkit');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for Toastkit');
    }
}